...
public class ExtraCreditDriver {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        /**
         * Using the forEach method and consumer interface!!!
         */
        System.out.println("Using the forEach and consumer interface");
        ...
        //Can print in forward or reverse depending on what you comment out 
        // within the forEach method in DoublyLinkedList.java
